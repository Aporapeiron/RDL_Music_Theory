...
def build_frames() -> list[MotifMemoryFrame]:
    ...
    return [
        ...
        MotifMemoryFrame(
            ...
            preserved_motif=MOTIF,
            preserved_motif_contour=preserved_contour,
            primary_interventions=("set return_motif_start_beat to 8", "set intervening_melodic_material to silence"),
            return_relation="motif returns at bar downbeat after four beats without melodic filler",
            derived_relations=("return_gap_beats = 4", "return_phase = 0", "intervening_duration_beats = 0"),
            memory_condition="motif is absent for one bar while meter reference continues without melodic filler",
            derived_memory_candidate="silent-gap delayed return candidate before actual listening",
            structural_prediction="delayed-return structural candidate after melodic-material silence",

...
1499〜1548から、source_reentry、update_request、policy_layer、entry_layer、partition_layer、update_view、bundle、integrity、non_identity、music_subject、summary、next_planの位相を抽出する。解決後のmemory updateをcompletionやfinal resolutionにせず、

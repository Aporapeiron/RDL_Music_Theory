...
現在の入口：`40_中核音楽理論/00_中核音楽理論_計画表.md` / Module計画作成済み：`01_音高調律`〜`10_記譜綴り` / 横断レビュー：`40_中核音楽理論/11_全Module横断レビュー_破断と最小検証.md` / 作成済み検証：`10_検証/42_和声機能_同一和音とkey_context分岐_最小実験.md`、`10_検証/43_和声機能_target候補集合と選択境界_最小実験.md` / 次：`10_検証/44_声部進行_selected_targetから具体音実現境界_最小実験.md`
